...
# ===CNN===
def test_with_saved_cnn(model_path='cnn_model.h5', csv_path='Scenario-A-merged_5s_adversarial.csv'):
...
def main():
    ...
    df_results.to_csv('cnn_perturbation_all_combined.csv', index=False)
    print("\n所有结果已保存至 cnn_perturbation_all_combined.csv")
