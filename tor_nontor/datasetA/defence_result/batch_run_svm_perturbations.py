...
#  SVM 
def test_with_saved_svm(model_path='svm_model.pkl', csv_path='Scenario-A-merged_5s_adversarial.csv'):
...
def main():
    ...
    df_results.to_csv('svm_perturbation_results.csv', index=False)
    print("\n所有结果已保存至 svm_perturbation_results.csv")
